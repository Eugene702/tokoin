const addShippingFormModal = () => {
    return <dialog id="add-shipping-form" className="modal">
        <div className="modal-box">
            ...
            <form className="grid grid-cols-1 gap-2">
                ...
                <div className="mt-2">
                    <button type="submit" className="btn btn-primary rounded-full btn-block text-white">Add address</button>
                    <form method="dialog">
...
export default addShippingFormModal